...
namespace Worker
{
    public class Program
    {
        ...
        {
            // Read connection config from environment variables (injected by Docker Compose or k8s Secret)
            ...
            var pgConnStr  = $"Server={pgHost};Username={pgUser};Password={pgPassword};Database={pgDatabase};";
